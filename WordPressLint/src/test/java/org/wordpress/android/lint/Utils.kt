...
/* The null annotations are copied here for usage in testing. This is necessary because without it,
   the qualifiedName of the UAnnotation node does not report the fully annotated name.
 */

object Utils {
    val nullableClass: TestFile
        get() = TestFiles.kotlin(
                "src/androidx/annotation/Nullable.kt",
                """ 
/*
...
public annotation class Nullable
    ...
    val nonNullClass: TestFile
        get() = TestFiles.kotlin(
                "src/androidx/annotation/NonNull.kt",
                """ 
/*
 * Copyright (C) 2013 The Android Open Source Project
 *
